...
Whether future development of Zax is useful or necessary is a good question.  It was originally intended to be a cross-platform Z-machine (hence the choice of Java for implementation), but a lot of very cool Java Z-Machines have been written in the meantime.  I'd love to hear opinions on the future of Zax; if there's some genuine interest in developing it further, I might put it into a more collaborative form like a SourceForge project.  E-mail me if you're interested.
